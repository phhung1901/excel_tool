...
class TextReducer
{
     ...
     */
    public static function text($string, $max_length = 100, $replacement = '...')
    {
     ...
     * @return string|string[]|null
     */
    public static function url($url, $max_length = 100, $replacement = '...')
    {
     ...
     * @return string|string[]|null
     */
    public static function path($path, $max_length = 100, $replacement = '...', $directory_separate = '/')
    {
